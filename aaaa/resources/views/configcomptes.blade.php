    ...
    <main onclick="hideall()">
        ...
        <div class="mail" >
            ...
            <div class="mail-title">
                ...
                <a class="btn" id="aj-btn" href="ajoutercompte"> ajouter comptes</a>
            </div>
            <!--end main-top-->
            <!--start main tab-->
            <div class="tab">
                ...
                <div class="tab-title">
                    ...
                    <div class="tab-title-bottom">
                        <p id="titre-tab">all options</p>
                        <form class="search" action='searchoption'>
                ...
                <ul>
                    ...
                    <li>
                        <p>{{ $r["idUser"] }}</p>
                        <p id="nom">{{ $r["nom"] }}</p>
                        <p id="email">{{ $r["email"] }}</p>
                        <p>{{ $r["psw"] }}</p>
                        <p >{{ $r["Tel"] }}</p>
                        <p id="adresse">{{ $r["adresse"] }}</p>
                        <p>{{ $r["typee"] }}</p>
                        <p> <img  id="imgcompte" src="img/{{ $r["Photo"] }}" alt="">     </p>
                        <ul id="action">
                            <li  ><a href="compteedite/{{  $r["idUser"] }}"><i class="fal fa-pencil-alt"></i></a></li>
                            <li ><a href="/removecompte/{{ $r["idUser"]  }}"><i class="fal fa-trash-alt"></i></a></li>
                        </ul>
                ...
                <span> {{ $dt->links('pagination-links') }}  </span>
