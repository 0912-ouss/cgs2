    ...
    <header>
        ...
        <nav>
            ...
            <div class="li-show" id="li-mailapp">
                <ul>
                    <li><i class="fad fa-angle-right"></i><a href="#">mail</a></li>
                    <li><i class="fad fa-angle-right"></i><a href="#">motification</a></li>
                ...
                <div class="conver-contact">
                    <div class="title">
                        ...
                        <div class="title-bottom">
                            <ul>
                                <li class="active" id="li-disc"  onclick="mmsgshow()">resent discution</li>
